...
import { useFloatingActionButtonStyles } from '../styles/styles';

const FloatingActionButton = ({ width, onClick, to, title, isLink }) => {
...
export default withWidth()(FloatingActionButton);
